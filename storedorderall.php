  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <a href="showcustomer.php"><button class="btn-outline-dark ">Access all customer info</button></a><br><br>
        ...
        <div class="col-md-9">
           <h1 class="cap">Full delivery report from the very fast</h1>
